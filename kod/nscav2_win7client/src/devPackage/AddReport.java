...
public class AddReport
{
	public AddReport(BlockingQueue<PerfmonResult> blockingQueue)
	{
		try
		{
			blockingQueue.put(new PerfmonResult("C:\\Users\\Miko\\AppData\\Roaming\\Nscav2_client\\MIKO-KOMPUTER_20151017-000080", new Date().getTime(), CriticalEvent.MEMORY, "MIKO-KOMPUTER_20151017-000080"));
