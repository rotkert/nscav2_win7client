...
public class AESModule
{
	...
	/**
	 * Constructor of AESModule, sets instance of symmetric algorithm for cipher
	 */
	public AESModule()
	{
		try
		{
			...
			cipherEncrypt.init(Cipher.ENCRYPT_MODE, symmetricKey, initializationVector);
			cipherDecrypt.init(Cipher.DECRYPT_MODE, symmetricKey, initializationVector);
		} catch (Exception e)
		{
	...
	/**
	 * Updates encrypt initialization vector after encryption (to maintain flow
	 * of algorithm)
	 * 
	 * @param array
	...
	public void updateEncryptVector(byte[] array)
	{
		try
		{
			cipherEncrypt.init(Cipher.ENCRYPT_MODE, this.symmetricKey, new IvParameterSpec(array));
		} catch (Exception e)
		{
			// TODO
		}
	...
	/**
	 * Updates decrypt initialization vector after encryption (to maintain flow
	 * of algorithm)
	 * 
	 * @param array
	 *            new initialization vector
	...
	public void updateDecryptVector(byte[] array)
	{
		try
		{
			cipherDecrypt.init(Cipher.DECRYPT_MODE, this.symmetricKey, new IvParameterSpec(array));
		} catch (Exception e)
		{
			// TODO
		}
